<?php
namespace Ext\Aliaop\aop;

class AopClient {
	//应用ID
	public $appId="2016071401616834";
	
	//私钥文件路径
	public $rsaPrivateKeyFilePath = '/mnt/hgfs/www/ruigumobileApi/vendor/ext/Alipay/key/rsa_private_key.pem';
     ...
     * @author mengyu.wh
     */
	public function alonersaSign($data,$privatekey,$signType = "RSA",$keyfromfile=true) {
